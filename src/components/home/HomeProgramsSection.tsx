  ...
  return (
    <div className="relative max-w-7xl mx-5 xl:mx-auto flex flex-col items-center gap-4">
      ...
      <div className="grid grid-cols-1 gap-x-8 gap-y-8 rounded-3xl">
        {homeProgramsData.map((data, index) => (
          <div
            key={index}
          ...
          >
            {/* Image */}
            <div className="flex-none flex flex-row items-center justify-center md:w-[150px] md:h-[150px]
            ...
            <div className="flex-1 p-4 md:p-6 flex flex-col gap-3">
              <div className="flex flex-row justify-center md:justify-between gap-2 items-center">
                ...
                <ArrowRightUpwardIcon width="20" height="20" viewBox="0 0 25 25"/>
              </div>
              <p className="line-clamp-3 text-center md:text-left">{data.content}</p>
            </div>
          </div>
        ))}
      </div>
